...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\joy_mapper\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\joy_mapper\hook\ament_prefix_path.bat"
